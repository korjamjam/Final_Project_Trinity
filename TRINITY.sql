...
COMMENT ON COLUMN USER_TABLE.USER_NO IS '사용자 고유 번호';
COMMENT ON COLUMN USER_TABLE.USER_ID IS '사용자 아이디';
COMMENT ON COLUMN USER_TABLE.USER_PWD IS '사용자 비밀번호';
COMMENT ON COLUMN USER_TABLE.USER_NAME IS '사용자 이름';
COMMENT ON COLUMN USER_TABLE.EMAIL IS '사용자 이메일';
COMMENT ON COLUMN USER_TABLE.PHONE IS '사용자 전화번호';
COMMENT ON COLUMN USER_TABLE.BIRTHDAY IS '사용자 생일';
COMMENT ON COLUMN USER_TABLE.GENDER IS '성별';
COMMENT ON COLUMN USER_TABLE.ADDRESS IS '주소';
COMMENT ON COLUMN USER_TABLE.ENROLL_DATE IS '등록 일자';
COMMENT ON COLUMN USER_TABLE.STATUS IS '사용자 상태';
COMMENT ON COLUMN USER_TABLE.ISADMIN IS '관리자 여부';
COMMENT ON COLUMN USER_TABLE.MED_KEY IS '의사 고유 번호 (외래 키)';
COMMENT ON COLUMN USER_TABLE.HOS_NO IS '병원 고유 번호 (외래 키)';
