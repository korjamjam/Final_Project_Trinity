...
CREATE SEQUENCE SEQ_VIRES_NO START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE TABLE GUEST (
    GST_NO VARCHAR2(10) NOT NULL PRIMARY KEY,
...
CREATE TABLE GENERAL_RESERVATION (
    G_RES_NO VARCHAR2(10) NOT NULL PRIMARY KEY,
    USER_NO VARCHAR2(10) NOT NULL,
    HOS_NO VARCHAR2(10) NOT NULL,
    GST_NO VARCHAR2(10),
...
CREATE TABLE VACCINE_RESERVATION (
    VRES_NO VARCHAR2(10) NOT NULL PRIMARY KEY,
    USER_NO VARCHAR2(10) NOT NULL,
    HOS_NO VARCHAR2(10) NOT NULL,
    GST_NO VARCHAR2(10),
    PATIENT_NAME VARCHAR2(20) NOT NULL,
    PATIENT_BIRTHDAY NUMBER NOT NULL,
    VRES_DATE DATE NOT NULL,
    VRES_TIME VARCHAR2(20) NOT NULL,
    V_TYPE VARCHAR2(20) NOT NULL,
    RES_CONTENT VARCHAR2(3000),
    FOREIGN KEY (USER_NO) REFERENCES MEMBER (USER_NO),
    FOREIGN KEY (HOS_NO) REFERENCES HOSPITAL_INFO (HOS_NO),
    FOREIGN KEY (GST_NO) REFERENCES GUEST (GST_NO)
);
...
CREATE TABLE HEALTH_RESERVATION (
    HRES_NO VARCHAR2(10) NOT NULL PRIMARY KEY,
    USER_NO VARCHAR2(10) NOT NULL,
    GST_NO VARCHAR2(10),
    HOS_NO VARCHAR2(10) NOT NULL,
    PATIENT_NAME VARCHAR2(20) NOT NULL,
...
CREATE TABLE H_SUBJECT (
    SUB_KEY NUMBER NOT NULL PRIMARY KEY,
    HOS_NO VARCHAR2(10) NOT NULL,
...
FOR EACH ROW
BEGIN
    :NEW.VRES_NO := 'VR' || TO_CHAR(SEQ_VIRES_NO.NEXTVAL);
END;
/
...
FOR EACH ROW
BEGIN
    :NEW.HRES_NO := 'HR' || TO_CHAR(SEQ_H_RES_NO.NEXTVAL);
END;
/
...
CREATE OR REPLACE TRIGGER trg_member_med_key
BEFORE INSERT OR UPDATE ON MEMBER
FOR EACH ROW
BEGIN
    -- MED_KEY가 NULL이면 일반 사용자로 설정
    IF :NEW.MED_KEY IS NULL THEN
        :NEW.ISADMIN := 'N'; -- 일반 사용자
    ELSE
        :NEW.ISADMIN := 'Y'; -- 의사
    END IF;
END;
