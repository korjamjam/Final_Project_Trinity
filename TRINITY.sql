...
INSERT INTO DOCTOR_REVIEW (USER_NO, REVIEW_TITLE, REVIEW_CONTENT, REVIEW_CREATED_AT, REVIEW_UPDATED_AT, REVIEW_RATING) 
VALUES ( 'U7', '최고의 진료 경험', '의사 선생님께서 정말 친절하고 전문적으로 상담해 주셨습니다.', SYSDATE, SYSDATE, 5);

INSERT INTO DOCTOR_REVIEW (USER_NO, REVIEW_TITLE, REVIEW_CONTENT, REVIEW_CREATED_AT, REVIEW_UPDATED_AT, REVIEW_RATING) 
VALUES ( 'U7', '만족스러운 진료', '대체로 만족스러웠으나 대기 시간이 조금 길었습니다.', SYSDATE, SYSDATE, 4);

INSERT INTO DOCTOR_REVIEW ( USER_NO, REVIEW_TITLE, REVIEW_CONTENT, REVIEW_CREATED_AT, REVIEW_UPDATED_AT, REVIEW_RATING) 
VALUES ('U7', '꼼꼼한 진료', '의사 선생님께서 꼼꼼히 진료해 주셔서 안심이 되었습니다.', SYSDATE, SYSDATE, 5);

INSERT INTO DOCTOR_REVIEW ( USER_NO, REVIEW_TITLE, REVIEW_CONTENT, REVIEW_CREATED_AT, REVIEW_UPDATED_AT, REVIEW_RATING) 
VALUES ('U7', '보통 수준의 진료', '진료는 무난했지만 개선할 점도 보였습니다.', SYSDATE, SYSDATE, 3);

INSERT INTO DOCTOR_REVIEW ( USER_NO, REVIEW_TITLE, REVIEW_CONTENT, REVIEW_CREATED_AT, REVIEW_UPDATED_AT, REVIEW_RATING) 
VALUES ('U7', '효과적인 치료', '치료 결과가 좋았으나 비용이 조금 부담스러웠습니다.', SYSDATE, SYSDATE, 4);
