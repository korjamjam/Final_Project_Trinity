...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DROP SEQUENCE SEQ_HOS_ACCOUNT_NO';
...
-- 기존 트리거 삭제
BEGIN
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_hospital_info_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_hospital_account_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_reservation_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_member_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_treatment_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_board_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_doctor_review_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_file_table_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_medical_field_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_board_views_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_review_views_id';
    EXECUTE IMMEDIATE 'DROP TRIGGER trg_views_id';
EXCEPTION
    WHEN OTHERS THEN
        NULL; -- 트리거가 존재하지 않을 경우 예외 무시
END;
/
