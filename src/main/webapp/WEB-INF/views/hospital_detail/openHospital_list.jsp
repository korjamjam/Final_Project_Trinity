...
<title>닥터링</title>
   ...
   <link href="https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@100..900&display=swap" rel="stylesheet">
    ...
    <!-- JS -->
    <script src="${ pageContext.servletContext.contextPath }/resources/js/hospital_detail/openHospital_list.js"></script>

</head>
<body onload="openHospitalListInit('${pageContext.servletContext.contextPath}')">
	<!-- Header -->
