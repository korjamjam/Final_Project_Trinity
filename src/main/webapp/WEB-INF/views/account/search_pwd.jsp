		...
		<div class="accordion">
			...
			<div class="accordion-item">
				...
				<div class="accordion-content">
					<form
						action="${pageContext.servletContext.contextPath}/member/reset_pwd_email"
						method="post">
						...
						<div class="input-group email-group">
							...
							<div class="email-inputs">
								<input type="text" id="email" name="email" placeholder="이메일 입력"
									...
									name="domain" placeholder="직접입력" required> <select
									class="domain-select" name="domainSelect">
			...
			<div class="accordion-item">
				...
				<div class="accordion-content">
					<form action="reset_pwd_phone.me" method="post">
						<div class="input-group">
							<label for="id-phone">아이디</label> <input type="text"
								id="id-phone" name="idPhone" placeholder="아이디" required>
						</div>
						<div class="input-group">
							<label for="phone-name">이름</label> <input type="text"
								id="phone-name" name="phoneName" placeholder="이름" required>
						</div>
						<div class="input-group">
...
$(document).ready(function() {
    ...
    $("form").submit(function(event) {
        ...
        $.ajax({
            ...
            error: function() {
                alert("서버 처리 중 오류가 발생했습니다."); // 서버 오류 처리
            }
        });
    });
});
