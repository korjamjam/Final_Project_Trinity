...
<link rel="stylesheet"
	href="${ pageContext.servletContext.contextPath }/resources/css/account/reset_pwd.css">
<link
...
<body>
	...
	<div class="container">
		...
		<div class="reset-form">
			<!-- 유저 아이디를 동적으로 표시 -->
			<p class="user-id">
				닥터링 아이디 : <span class="highlight">${loginUser.userId}</span>
			</p>
			<form
				action="${pageContext.servletContext.contextPath}/member/reset_pwd_confirm"
				method="post">
				...
				<p class="password-hint">* 영문 숫자 특수문자를 함께 사용해야 하며, 8자 이상 16자 이하만
					가능합니다.</p>
