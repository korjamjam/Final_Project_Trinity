...
<body>
    ...
    <div class="hamburger-sidebar-menu">
        ...
        <div class="sidebar-item" onclick="toggleSubmenu(this)">
            <p>고객문의</p>
            <div class="sidebar-submenu">
                <a href="${pageContext.servletContext.contextPath}/inquiry/notification">공지사항</a>
                <a href="${pageContext.servletContext.contextPath}/inquiry/notice">알림판</a>
                <a href="${pageContext.servletContext.contextPath}/inquiry/faq">FAQ</a>
                <a href="${pageContext.servletContext.contextPath}/inquiry/qna">Q&A</a>
            </div>
        </div>
