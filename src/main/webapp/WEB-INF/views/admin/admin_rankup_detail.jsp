...
<div class="rankup-management">
    ...
    <form action="${pageContext.request.contextPath}/admin/updateRankup" method="post">
        <table>
            <tr>
                <th>이름</th>
            ...
            <tr>
                ...
                <td>
                    <select name="status">
                        <option value="W" ${rankupDetail.status == 'W' ? 'selected' : ''}>대기</option>
                        <option value="A" ${rankupDetail.status == 'A' ? 'selected' : ''}>승인</option>
                        <option value="D" ${rankupDetail.status == 'D' ? 'selected' : ''}>거부</option>
                    </select>
                </td>
            </tr>
            <tr>
                <th>증명 파일</th>
                <td><a href="${rankupDetail.licPicture}" target="_blank">파일 확인</a></td>
            </tr>
        </table>
