		...
		<div class="post-wrapper">
			<form id="postForm" method="post"
				...
				<div class="mt-4">
					...
					<input type="file" id="upfile" name="upfiles" class="form-control"
						multiple onchange="checkFileValidation(this)"> <small
						id="fileHelp" class="form-text">최대 3개의 파일만 업로드할 수 있습니다. (각
						파일 최대 5MB)</small>
					<!-- 선택된 파일 리스트 표시 -->
