                   ...
                   <form method="post" action="${pageContext.request.contextPath}/community/write" class="post-form">
                        ...
                        <div class="post-form-container">
                            <div class="post-form-header">
                                  <select class="post-category-select" name="boardCategory" onchange="changeCategory(this.value)">
                                    <option>자유게시판</option>
                                    <option>메디톡</option>
                                    <option>이벤트게시판</option>
                                </select>
                               	<select class="post-tag-select" name="tag">
                           ...
                           <input type="text" name="boardTitle" placeholder="제목을 입력해 주세요." class="post-title-input">
                        </div>

                        <div class="spacer"></div> <!-- 여백을 추가하기 위한 요소 -->
                        <!-- 내용 입력(Summernote) -->
                        <textarea id="summernote" name="boardContent" class="post-textarea" required>></textarea>
