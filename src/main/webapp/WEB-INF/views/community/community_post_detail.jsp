<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <% // 테스트 목적으로 세션에 loggedInUser 값을 설정 session.setAttribute("loggedInUser", "jjhim531" ); %>
            <% String postId=request.getParameter("id"); // postId를 사용하여 데이터베이스에서 게시글 정보를 조회 %>
                <!DOCTYPE html>
                <html lang="ko">
                                    ...
                                    <td class="board-actions">
                                        ...
                                        <c:if test="${sessionScope.loggedInUser == 'jjhim531'}">
                                            <button class="white-button"
                                                onclick="location.href='editPost.jsp'">수정</button>
                                            ...
                                            <div class="custom-dropdown">
                                                ...
                                                <div class="option-list" id="community-options">
                                                    <div class="option-item"
                                                        onclick="moveSelectPage('community_main.me')">실시간 인기글</div>
                                                    <div class="option-item"
                                                        onclick="moveSelectPage('community_free.me')">자유 게시판</div>
                                                    <div class="option-item"
                                                        onclick="moveSelectPage('community_medical.me')">메디톡</div>
                                                    <div class="option-item"
                                                        onclick="moveSelectPage('community_event.me')">이벤트 게시판</div>
                                                </div>
                                            </div>
                                        </td>
