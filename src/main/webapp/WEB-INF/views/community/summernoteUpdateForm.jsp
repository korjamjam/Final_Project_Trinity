    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            ...
            <div class="content-container">
                ...
                <div class="top-bar">
                    <div class="left-section">
                        <h1>${b.categoryName} <span>글쓰기</span></h1>
                    </div>
                    ...
                    <form id="postForm" method="post" action="${pageContext.request.contextPath}/community/update"
                        ...
                        <div class="mt-4">
                            ...
                            <input type="file" id="upfile" name="upfiles" class="form-control" multiple
                                onchange="handleFileValidation(this)">
            ...
            <%@ include file="/WEB-INF/views/common/main_footer.jsp" %>
                ...
                <script
                    src="${pageContext.servletContext.contextPath}/resources/js/community/summernoteUpdateForm.js"></script>
        </body>
