	...
	<div class="main-page">
			...
			<main class="main-content">
				...
				<section class="notice-content">
					...
					<div class="inquiry-buttons">
						<button class="onebyone" onclick="showInquiryForm()">1:1
							문의하기</button>
						<button class="myinquiry" onclick="showInquiryList()">내
							문의내역</button>
					</div>

					<!-- Inquiry Form (Initially hidden) -->
					<div id="inquiryWriteForm" class="inquiry-write-form"
						style="display: none; padding-top: 10px;">
						<h3>1:1 문의 작성</h3>
						<form action="submitInquiry" method="post">
							<div class="form-group">
								<label for="inquiryType">문의 유형</label> <select id="inquiryType"
									name="inquiryType">
							...
							<div class="form-group">
								...
								<textarea id="content" name="content" rows="5" maxlength="500"
									required></textarea>
							</div>
							<div class="form-buttons">
								...
								<!-- <button type="submit" class="submit-button">등록</button> -->
								  <button type="button" onclick="handleRegisterClick()" class="submit-button">등록</button>
							</div>
						</form>
					</div>
		...
		<script>
            ...
            function handleRegisterClick() {
                ...
                // Q&A 페이지로 이동
                location.href = 'qna'; // 'qna'는 이동할 페이지 URL입니다.
            }
        </script>
	</div>
</body>
