		...
		<div id="main-wrapper">
			<div class="navigation-buttons">
				...
				<div class="left-section">
					<c:if
						test="${loginUser != null && loginUser.userId eq inq.inquiryWriter}">
						<!-- 수정 버튼 -->
				...
				<div class="right-section">
					<!-- 목록 보기 버튼 -->
					<a
						href="${pageContext.request.contextPath}/community/main?categoryId=${inq.categoryId}"
					...
					<div class="nav-links-group">
						...
						<c:choose>
							<c:when test="${prevBoard != null}">
								<a
									href="${pageContext.request.contextPath}/community/boardDetail?bno=${prevBoard.boardNo}"
						...
						<c:choose>
							<c:when test="${nextBoard != null}">
								<a
									href="${pageContext.request.contextPath}/community/boardDetail?bno=${nextBoard.boardNo}"
			...
			<div class="board-container">
						...
						<td><span>게시판 &nbsp;</span> &gt;
							<div class="custom-dropdown">
								<div class="selected-container">
									<!-- 선택된 카테고리 이름을 표시 -->
									<div class="selected-option" id="selected-category-name">${categoryName}</div>
				...
				<div class="board-content-wrapper">
					...
					<div>
						...
						<c:if
							test="${categoryName eq '메디톡' && loginUser != null && loginUser.medKey != null}">
								...
								<div class="answer-content">
									<div class="doctor-card">
										<div class="doctor-photo">
											<img
												src="${pageContext.servletContext.contextPath}/resources/img/doctor.jpg"
												alt="의사아이콘">
										</div>
